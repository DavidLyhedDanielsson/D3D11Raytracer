#ifndef PickingSharedBuffers_h__
#define PickingSharedBuffers_h__

#include "PickingSharedConstants.h"
...
namespace PickingSharedBuffers
{
#else
//HLSL
...
#endif // PickingSharedBuffers_h__