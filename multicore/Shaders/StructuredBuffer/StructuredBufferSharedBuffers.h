#ifndef StructuredBufferSharedBuffers_h__
#define StructuredBufferSharedBuffers_h__
...
namespace StructuredBufferSharedBuffers
{
#else
//HLSL
...
#endif // StructuredBufferSharedBuffers_h__