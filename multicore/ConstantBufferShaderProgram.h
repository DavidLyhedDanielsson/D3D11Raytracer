...
#include "Shaders/ConstantBuffer/ConstantBufferSharedBuffers.h"
...
{
public:
	ConstantBufferShaderProgram();
	~ConstantBufferShaderProgram() = default;
...
private:
	...
	ConstantBufferSharedBuffers::SphereBuffer sphereBufferData;

	//////////////////////////////////////////////////
	//Triangles
	//////////////////////////////////////////////////
	ConstantBufferSharedBuffers::VertexBuffer vertexBufferData;
	DXConstantBuffer triangleVertexBuffer;
	ConstantBufferSharedBuffers::TriangleBuffer triangleBufferData;
