...
bool ConstantBufferShaderProgram::InitShaders()
{
	...
	//CBuffers
	traceResourceBindInitial.AddResource(sphereBuffer, ConstantBufferSharedBuffers::SPHERE_BUFFER_REGISTRY_INDEX);
	traceResourceBindInitial.AddResource(triangleVertexBuffer, ConstantBufferSharedBuffers::VERTEX_BUFFER_REGISTRY_INDEX);
	traceResourceBindInitial.AddResource(triangleBuffer, ConstantBufferSharedBuffers::TRIANGLE_BUFFER_REGISTRY_INDEX);
